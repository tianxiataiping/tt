...
#指定项目地址
workspace_path="$project_path/OKEx.xcworkspace"
#指定输出路径,如果路径不存在则创建his
...
echo "fir login "
fir login -T 3420dc430203c4d6eda9ed36eac2168e
echo "fir publish "
#testipa="/Users/oker/Desktop/OKEX_archive/20180706/1833"
#fir publish ${testipa}/$ipa_name

fir publish ${output_path}/$ipa_name
