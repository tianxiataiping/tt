...
MAIL_LIST_QA = ['xiao.gong@okcoin.com','hui.you@okcoin.com','anran.hu@okcoin.com','dongdong.li@okcoin.com','junjie.wang@okcoin.com']
MAIL_LIST_OKCOIN = ['fan.yang@okcoin.com','hui.you@okcoin.com','anran.hu@okcoin.com','xiao.gong@okcoin.com','liying.li@okcoin.com','pusu.liu@okcoin.com','fangfang.zhang@okcoin.com','tao.dong@okcoin.com','pengxin.wang@okcoin.com','xiaokang.yang@okcoin.com']
MAIL_LIST_OKLINK = ['liying.li@okcoin.com','rongyao.zheng@okcoin.com','hui.you@okcoin.com','dongdong.li@okcoin.com','jingze.zhang@okcoin.com','junjie.wang@okcoin.com']
...
MAIL_LIST_OKEX = MAIL_LIST_OKCOIN
#MAIL_LIST_OKCOIN = ['hui.you@okcoin.com']
...
def mailList(appName):
    ...
    elif appName == OKEX_APP:
        mailList = MAIL_LIST_OKEX
    return mailList
...
if __name__ == "__main__":
    ...
    appName = sys.argv[3] #
    qrcodeImage(content) 
    mailList = mailList(appName)
    if send_mail(subject,content,mailList,"ios.png"):  
